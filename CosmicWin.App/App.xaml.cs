...
/// this class does nothing but delegate to
/// <see cref="AppComposition.WireProduction"/> and dispose the result. Four consecutive closures
/// (,,) tried to defend a composition site living directly in this WPF
...
public partial class App : Application
{
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
        ...
        // Single delegating call, pinned by AppEntryPointThinnessTests.
